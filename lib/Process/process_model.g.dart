...
class ProcessDetailsAdapter extends TypeAdapter<ProcessDetails> {
  @override
  final int typeId = 28;

  @override
  ProcessDetails read(BinaryReader reader) {
    ...
    return ProcessDetails()
      ...
      ..SubProcesses = fields[8] as int
      ..TaskProceesses = fields[9] as int;
  }

  @override
  void write(BinaryWriter writer, ProcessDetails obj) {
    writer
      ..writeByte(10)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is ProcessDetailsAdapter &&
