...
import 'package:pgmp4u/Process/processTaskDetails.dart';
...
class ProcessTaskList extends StatefulWidget {
  ...
  ProcessTaskList({Key key, this.subProcessLable, this.subProcessName}) : super(key: key);
                                  ...
                                  child: Container(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          return InkWell(
                                            onTap: () async {
                                              print("storedProcessTasks[index].id===${storedProcessTasks[index].id}");
                                              print("storedTasks[index].name===${storedProcessTasks[index].name}");
                                              pdp.getProcessTasksDetailData(storedProcessTasks[index].id);
                                              ...
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
                                                      builder: (context) => ProcessTaskDetails(
                                                            subProcessName: storedProcessTasks[index].name,
                                                            processTaskDetailsObj: storedProcessTasks[index],
                                                          )));
                                            },
                                            child: Padding(
