                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: aviAttempts.map<Widget>((title) {
                                          var index = aviAttempts.indexOf(title);
                                          return Container(
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                aviAttempts[index].attempted_date == null
                                                          ...
                                                          onTap: () {
                                                            Navigator.push(
                                                                ...
                                                                MaterialPageRoute(
                                                                    builder: (context) => RandomPage(
                                                                          index: 3,
                                                                          price: detailsofMockAttempt.price.toString(),
                                                                        )));
                                                          },
                                                          child:
                                                              Text(detailsofMockAttempt.premium == 1 ? "Premium" : ""),
                                                        )
                                                      ],
                                                    )
                                                  ],
